"""
Django settings for coulomb project.
...
SECRET_KEY = 'django-insecure-55@3s+x6waf_^pcu@h$!un*gph(%b3x1h62$3uln6govh)9art'
...
WSGI_APPLICATION = 'coulomb.wsgi.application'
...
#AUTH_USER_MODEL = 'event_registrations.participant'
